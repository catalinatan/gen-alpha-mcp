...
def run(
    ...
    golden: str = typer.Option("golden_sets/gen_alpha.json", "--golden", "-g", help="Path to the golden set JSON file."),
    prompt: str = typer.Option("prompts/v1.txt", "--prompt", "-p", help="Path to the prompt template file."),
) -> None:
